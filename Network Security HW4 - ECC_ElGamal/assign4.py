...
# Note that we need to represent the plaintext as a point on the curve and there is no guarantee that, given any x-coordinate, 
# we can always find a y (as a solution) such that (x,y) is on the curve. 
# This can be achieved by using 8 don’t-care bits in the x-coordinate, as shown in the Data Embedding Method below.
...
# Cm = {Pk, Pb} = {7AF4ED0D220D9482424E72FE5A375C6BFC2B0743, 15A7D667CDA436F401E61569109D753ECD1F0B1}

# Plaintext M = 8E6F2C1DC3987AFECCC6F7DDFF75EDFC324DF6
# Pa_x = 039994C5C16070EE878F89A6143CE865AC2EC7EC5D
...
# Cm = {Pk, Pb} = {EFE1AC151C68EDAF3AA85E8D5589FCE27D4C405B, 8970C8F5C2BB301E5EC4D31DDB22524294FDACED}
...
# Cm = {Pk, Pb} = {BDC5D14A5BA16F6787A050C6CD2F4C4C72AD2671, A9FC4BBA3F7B3D53D3CEF8D0D9F0165882541CE2}


# ----------------------------------------- <EC-ElGamal Decryption> -----------------------------------------------
# Pk = 023D5A5C8A80799494624E741A0119804FF707A2AB
# Pb = 023C83F7C52185D5ACBE56171880995F591DFE5C3C
# na = 3C870C3E99245E0D1C06B747DEB3124DC843BB8B
# Plaintext = 2923BE84E16CD6AE529049F1F1BBE9EBB3A6DB

# Pk = 03EFE1AC151C68EDAF3AA85E8D5589FCE27D4C405B
# Pb = 038970C8F5C2BB301E5EC4D31DDB22524294FDACED
# na = 3C870C3E99245E0D1C06B747DEB3124DC843BB8B
# Plaintext = 8E6F2C1DC3987AFECCC6F7DDFF75EDFC324DF6
