/*
    ...
    added 4 friend functions: big_random(), NthCatalan(), NthFibonacci(), Factorial()

    reference link: https://github.com/faheel/BigInt
*/
...
class BigInt {
    ...
    public:
        ...
        friend BigInt NthCatalan(size_t n);
        friend BigInt NthFibonacci(size_t n);
        friend BigInt Factorial(size_t n);
        friend BigInt big_power(BigInt x, BigInt y, BigInt p);
};

#endif  // BIG_INT_HPP

/* Iterative Function to calculate (x^y) % p in O(log y) */
BigInt big_power(BigInt x, BigInt y, BigInt p) {
    BigInt res;
